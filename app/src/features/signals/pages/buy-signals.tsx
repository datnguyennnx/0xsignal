    ...
    Exit.match({
      onFailure: () => (
        <div className="max-w-4xl mx-auto space-y-4">
          <div>
            <h1 className="text-2xl font-bold">Buy Signals</h1>
          </div>
      ...
      onSuccess: (analyses) => {
        ...
        return (
          <div className="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold">Buy Signals</h1>
              <p className="text-sm text-muted-foreground mt-1">{buySignals.length} signals</p>
            </div>

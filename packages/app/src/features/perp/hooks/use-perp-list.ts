 ...
 * Filters out delisted and inactive (zero open interest) coins for the UI.
 *
 * @mechanism
 * - Combiles meta context and all-mids data to provide a complete view
 * - Sorts assets by open interest (descending) as a proxy for relevance
 *

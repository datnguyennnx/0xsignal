/**
 * @overview Depth Chart Materialization Engine
 *
 * Handles the actual bucketing and filtering of L2 levels for the depth chart display.
 * Implements "step hysteresis" to prevent flickering when zooming or when price change slightly.
 *
 * @mechanism
 * - uses BUCKET_LADDER to determine optimal bucket count based on viewport width.

/**
 * @overview Depth Chart Step Transformation
 *
 * Implements the logic to convert discrete price levels into "step-like" points for the canvas.
 * This ensures that the depth chart looks like a staircase rather than a continuous curve.
 *
 * @mechanism
 * - duplicates points at the same price with different totals to create 90-degree vertical lines.
 * - handles price sorting and tick size inference to maintain geometric precision.
 */

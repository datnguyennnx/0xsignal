/**
 * @overview Indicator Data Hook — transforms raw candlestick data into indicator time-series
 * @file use-indicator-data.ts
 *
 ...
 *
 * @performance
 * - Module-level LRU cache avoids React Compiler ref-in-render warnings
 * - Cache key includes full data fingerprint, so different candles/recalculations don't collide
 * - LRU eviction at MAX_CACHE_SIZE prevents unbounded memory growth across symbol switches
 */

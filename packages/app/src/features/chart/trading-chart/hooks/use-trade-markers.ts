/**
 * @overview React hook that computes trade markers from Hyperliquid fills
 * and validates marker ↔ candle alignment in development.
 *
 * @design
 * - `useMemo` recomputes logical markers only when fills, timeframe, or coin change.
 * - Dev validation builds a Set of candle times and warns on mismatches.
 * - HTML overlay rendering is handled by a separate `TradeMarkersOverlay` component.
 */

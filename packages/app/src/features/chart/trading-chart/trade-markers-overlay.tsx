/**
 * @overview TradeMarkersOverlay — renders stacked B/S circles above each candle
 * with Hyperliquid-style tooltips on hover.
 *
 * Markers per candle are grouped, stacked vertically above the candle high,
 * and capped at MAX_STACK_PER_CANDLE to avoid overflow. A tooltip shows the
 * trade direction and price when hovering a marker.
 */

...
import { formatPriceValue } from "../utils/price-format";
...
export const ChartOhlcOverlay = memo(({ data, precision }: ChartOhlcOverlayProps) => {
  ...
  return (
    <div className="absolute top-2 left-2 right-2 z-30 px-2.5 py-1.5 bg-card/90 backdrop-blur-sm rounded-lg text-[clamp(0.625rem,0.5rem+0.2vw,0.75rem)] select-none overflow-x-auto scrollbar-hide w-fit">

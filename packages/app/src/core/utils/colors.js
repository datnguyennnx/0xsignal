...
// ===== CANDLESTICK COLORS =====
export const getCandlestickColors = (isDark) => ({
...
// ===== VOLUME COLORS =====
export const getVolumeColor = (isUp, isDark) => {
  if (isUp) return isDark ? "#22c55e" : "#16a34a";
  return isDark ? "#ef4444" : "#dc2626";
};
// ===== HEATMAP COLOR SCALE =====
// More balanced intensity - not too bright
export const getHeatmapColor = (change, isDark) => {
...
export const getIndicatorColors = (isDark) => [

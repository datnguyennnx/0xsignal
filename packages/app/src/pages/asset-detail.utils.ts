/**
 * @overview Asset Detail Formatting Helpers
 *
 * Page-specific formatting utilities for the asset detail page.
 * Generic formatters live in core/utils/formatters.ts.
 */
